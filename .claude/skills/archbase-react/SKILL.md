...
Este documento contém a referência completa dos componentes e padrões do Archbase React v4.

**IMPORTANTE**: Documentação validada contra a biblioteca archbase-react-v4 com Mantine v9.
...
Versão: 4.0.0 (Mantine v9)
Atualizado: 2026-05-05. Inclui padrões modernos dos projetos VendaX, GestorRQ e boilerplate.
